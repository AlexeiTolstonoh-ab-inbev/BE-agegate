				...
				<div className={styles.ageGateWrapper}>
					<div className={styles.ageGateContainer}>
						...
						{isAccess ? <div className={styles.ageGateUnderAge}>
							...
							<form onSubmit={(evt)=>submitHandler(evt)} className={styles.ageGateUnderAge}>
								<div className={styles.inputContainer}>
									<input ref={dayInput} className={styles.dataInput} onChange={e =>  changeDay(e)} autoFocus  type="text" name="agegate-d" required={true} pattern={`^[ 0-9]+$`} minLength={2} maxLength={2} placeholder={langueage === 'fr'? 'jj' : 'dd'} tabIndex={0}></input>
									<input ref={mounthInput} className={styles.dataInput} onChange={e => changeMounth(e)} type="text" name="agegate-m" required={true}  pattern={`^[ 0-9]+$`} minLength={2} maxLength={2} placeholder="mm" tabIndex={0}></input>
									<input ref={yearInput} className={styles.dataInput} onChange={e => changeYear(e)}type="text" name="agegate-y" required={true}  pattern={`^[ 0-9]+$`} minLength={4} maxLength={4} placeholder={langueage === 'fr'? 'aaaa' : langueage === 'nl'? 'jjjj' : 'yyyy'} tabIndex={0}></input>
								</div>
